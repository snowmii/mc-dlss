 ...
 * number [me.snowmii.dlss.streamline.LifecycleAdapter.configureFg] records AND the swapchain
...
class FgSurfacePolicy(
	 ...
	 *
	 * Written by [RenderRuntime.setFgMultiplier] on a successful native
