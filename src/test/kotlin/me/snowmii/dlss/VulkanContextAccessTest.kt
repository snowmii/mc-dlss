...
/**
 * M-7 rung: proves [DlssVulkanContext] captures a real, non-zero Vulkan instance,
 ...
 *
 * The test drives the exact production seams ([DlssVulkanContext.fromNativeHandles],
 * [DlssVulkanContext.recordCommandBuffer], [VulkanContextRegistry]) against a headless
...
class VulkanContextAccessTest {
	...
	fun capturesNonZeroHandlesAndProducesRecordingCommandBuffer() {
		HeadlessVulkanFixture().use { fixture ->
			...
			assertEquals(context, VulkanContextRegistry.current)
		}
	}
}
